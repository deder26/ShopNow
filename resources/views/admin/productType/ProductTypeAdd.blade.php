...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="panel-body">
			...
			@endif 
			{{ Form::open(['route'=>'SaveProductType', 'method'=>'POST','class'=>'form-horizontal'])}}
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<textarea name="productType_description" class="form-control"></textarea>
					<span class="text-danger">{{$errors->has('productType_description') ? $errors->first('productType_description') : ''}}</span>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-8 col-lg-offset-4">
					<input type="submit" name="btn" class="btn btn-success" value="Save Product Type  Info" />
				</div>
			</div>
			{{ Form::close()}}
		</div>
