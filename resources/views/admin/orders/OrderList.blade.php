			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						...
						<a href="{{route('OrderConfirm',['id'=>$order->order_id])}}" class="btn btn-success btn-xs" title="Confirm Order"> 
						<span class="glyphicon glyphicon-edit"></span>
						</a> 
						
						<a href="{{route('PaymentOfOrderConfirm',['id'=>$order->order_id])}}" class="btn btn-warning btn-xs" title="Confirm Payment"> 
						<span class="glyphicon glyphicon-edit"></span>
						</a> 
